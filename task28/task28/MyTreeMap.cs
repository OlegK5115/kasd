...
namespace task28
{
    ...
    public class MyTreeMap<K, V> : IMyNavigableMap<K, V> where K : IComparable<K> where V : IComparable<V>
    {
        ...
        public void PutAll(IMyMap<K, V> m)
        {
        ...
        public bool Remove(object key) => RemoveNode((K)key).Key.Equals(key);
        ...
        public IMySortedMap<K, V> HeadMap(K key)
        {
            MyTreeMap<K, V> map = new MyTreeMap<K, V>();

            HeadMapRecursive(key, Root, map, false);
        ...
        public IMySortedMap<K, V> SubMap(K fromKey, K toKey)
        {

            MyTreeMap<K, V> map = new MyTreeMap<K, V>();

            SubMapRecursive(fromKey, toKey, Root, map, true, false);
        ...
        public IMySortedMap<K, V> TailMap(K from)
        {
            MyTreeMap<K, V> map = new MyTreeMap<K, V>();

            TailMapRecursive(from, Root, map, false);
        ...
        {
            MyTreeMap<K, V> map = new MyTreeMap<K, V>();
            HeadMapRecursive(key, Root, map, true);
        ...
        {
            MyTreeMap<K, V> map = new MyTreeMap<K, V>();
            TailMapRecursive(key, Root, map, true);
